...
setwd("C:/Users/Administrador/OneDrive - Fundo Nacional de Desenvolvimento da Educação/Pessoal/Cursos/FCD/5 - Business Analitics/Cap08 - RH Analitics/18-Cap08")
getwd()
...
#precisou usar aspas porque o nome da variável está com espaço
...
levels(dados_rh$Attrition)
levels(dados_rh$DistanceFromHome) # levels funciona somente em factor
levels(dados_rh$Education)
summary(dados_rh$Attrition)
...
# gerou arquivos com valor inf devido a divisão por 0
...
# Plots de análise univariada - aqui criou um gráfico para analisar cada variável
...
hist(dados_rh$PriorYearsOfExperience)
# Exemplo de insight:
...
prop.table(dados_rh$Education) # não funciona em fatores
...
# use = "complete.obs" elimina o que for valor NA. Mesmo coisa do procedimento utilizado acima
...
summary(modelo_v1)
?vif #variáveis mais importantes do modelo
vif(modelo_v1)
